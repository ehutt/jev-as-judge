...
This repository compares two ways of using Jev as an evaluator with five language-model judges. Every judge sees the same 532 examples across ten Phoenix classification tasks. The default experiment repeats each example ten times and records accuracy, consistency, latency, token usage, and cost in Phoenix.
